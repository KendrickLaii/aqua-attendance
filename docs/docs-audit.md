...
| F5 | 手冊／README 仍寫 Alembic head `034`、課程頁為學生優先、無學費發票 | ✅ 已修（2026-08-28）— head **037**；§1.9 班次名冊 + 上課日；§1.10 學費發票。2026-09-15 再同步：head **7d340d0ce7de**；堂費改 `enrollment_purchases` 購買追蹤；手動發票落庫＋每中心編號。2026-09-17 再同步：head **c3e7a95b2d10**；堂數單一來源；作廢即釋放購買 |
