...
| DB4 | ~~Migration 歷史未包含 032~~ | ✅ 已修 — 2026-09-24 再更新至 **d4b8e2a1c7f0**（收條、adjustments、credit note 抬頭） |
...
| F5 | 手冊／README 仍寫 Alembic head `034`、課程頁為學生優先、無學費發票 | ✅ 已修 — 2026-09-24 再同步：head **d4b8e2a1c7f0**；§1.10 Credit Notes；§1.12 收條 |
