...
> 最後更新：2026-09-17（手動發票不受一人一期一單限制、作廢發票即時釋放堂費購買、堂數單一來源（drop `purchased_quantity`））。2026-09-15（手動發票落庫＋可結算堂費購買、每中心發票編號系列、`enrollment_purchases` 追蹤；發票列印已做）。2026-09-04（堂費改一次性 `purchased_quantity` 收費，**#M23** 失效；ERP 確認不在本 repo 做，**#F1** 更新）。歷史：已審查：2026-07-28；2026-08-27 補學費發票／課程計價缺口；2026-08-28 堂費按上課日計堂；文首補 **#F1** ERP 路線 → [erp-roadmap.md](erp-roadmap.md)
