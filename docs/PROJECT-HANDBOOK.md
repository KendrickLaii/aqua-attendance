...
> 本文檔將 `docs/` 資料夾內所有文件統合為一本手冊，以繁體中文呈現。最後更新：2026-06-08。
...
| **Product** (`products`) | 可簽到的實體：`staff` 或 `student` |
| **Attendance event** | `check_in`、`check_out` 或 `manual_correction` |

### 1.2 倉庫結構

| 路徑 | 說明 |
|------|------|
| `apps/api/` | FastAPI — 認證、Product、QR 簽名、Attendance |
...
> 本手冊統合來源：`README.md`、`docs/README.md`、`docs/DEPLOY.md`、`docs/CICD-EXPLAINED.md`、`docs/KNOWN-GAPS.md`、`docs/CODE-REVIEW-2026-06.md`、`docs/RUNBOOK.md`、`docs/RELEASE-2026-05.md`、`docs/MOBILE-SPRINT.md`、`docs/MOBILE-RELEASE-CHECKLIST.md`、`docs/LOCATIONS.md`。
