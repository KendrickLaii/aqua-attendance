...
export async function createTaxReturnFieldSetup(
  ...
  return await $authApi('/tax_additional_info_template/create', {
    method: 'POST',
    body: payload,
    onResponseError({ response }) {
...
export async function updateTaxReturnFieldSetup(
  ...
  return await $authApi('/tax_additional_info_template/edit', {
    method: 'PUT',
    body: payload,
    onResponseError({ response }) {
...
export async function deleteTaxReturnFieldSetup(uuid: string) {
  return await $authApi('/tax_additional_info_template/del', {
    method: 'DELETE',
    body: { uuid, data: [uuid] },
    onResponseError({ response }) {
