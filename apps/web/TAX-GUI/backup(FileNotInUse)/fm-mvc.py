                ...
                <div style="width: 35%; text-align: center;">
                    ...
                    <form>
                        <div style="margin-bottom: 10px;">
                            ...
                            <input type="text" id="company-code" name="company-code" value="57457963000" style="width: 100%; padding: 8px;" disabled>
                        </div>
                        <div style="margin-bottom: 10px;">
                            <label for="license-no">License No.</label><br>
                            <input type="text" id="license-no" name="license-no" value="7283-EF33-VC34-MM23" style="width: 100%; padding: 8px;" disabled>
                        </div>
