...
class SimpleBrowser(wx.Frame):
                ...
                <div style="width: 35%; text-align: center;">
                    ...
                    <form>
                        <div style="margin-bottom: 10px;">
                            ...
                            <input type="text" id="company-code" name="company-code" value="CHK" style="width: 100%; padding: 8px;" disabled>
                        </div>
                        <div style="margin-bottom: 10px;">
                            <label for="license-no">License No.</label><br>
                            <input type="text" id="license-no" name="license-no" value="89O1-72A3-NNB2-DDOI" style="width: 100%; padding: 8px;" disabled>
                        </div>
    ...
    def handle_custom_scheme(self, request):
        ...
        self.browser.LoadURL("http://158.247.248.96:7001/client") # Replace with AQUA IP/ DOMAIN
    ...
    def add_buttons(self):
        ...
        self.panel.Layout()
app = wx.App(False)
frame = SimpleBrowser(None, wx.ID_ANY, "AQUAv20241209")
frame.Show()
frame.Center()
app.MainLoop()
