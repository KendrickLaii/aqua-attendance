                ...
                <div style="width: 35%; text-align: center;">
                    ...
                    <form>
                        <div style="margin-bottom: 10px;">
                            ...
                            <input type="text" id="company-code" name="company-code" value="CCP" style="width: 100%; padding: 8px;" disabled>
                        </div>
                        <div style="margin-bottom: 10px;">
                            <label for="license-no">License No.</label><br>
                            <input type="text" id="license-no" name="license-no" value="VN23-AS23-HJGD-LOP2" style="width: 100%; padding: 8px;" disabled>
                        </div>
