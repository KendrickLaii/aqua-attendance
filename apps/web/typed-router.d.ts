...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    'attendance-my-qr': RouteRecordInfo<'attendance-my-qr', '/attendance/my-qr', Record<never, never>, Record<never, never>>,
    ...
    'pages-misc-under-development': RouteRecordInfo<'pages-misc-under-development', '/pages/misc/under-development', Record<never, never>, Record<never, never>>,
